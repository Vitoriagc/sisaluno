    ...
    <div class="princ">
        ...
        <div class="menu">
            <div class="cadaluno">
                ...
                <button class="button"><a href="aluno/listaalunos.php">Mostrar lista de alunos.</a></button>
            </div>
            <div class="cadprof">
                <h2>Professores:</h2>
                <h4>Clique para cadastrar novos professores.</h4>
                <button class="button"><a href="professor\cadprofessor.php">Cadastrar professor</a></button> <br>
                <h4><br>Clique para visualizar lista de professores cadastrados.</h4>
                <button class="button"><a href="professor\listaprofessor.php">Mostrar lista de professores</a></button>
            </div>
            <div class="caddisciplinas">
                <h2>Disciplinas:</h2>
                <h4>Clique para cadastrar disciplinas.</h4>
                <button class="button"><a href="disciplina\caddisciplina.php">Cadastrar disciplina</a></button> <br>
                <h4><br>Clique para visualizar lista de disciplinas cadastrados.</h4>
                <button class="button"><a href="disciplina\listadisciplina.php">Mostrar lista de disciplina</a></button>
            </div>
        </div>
    </div>
